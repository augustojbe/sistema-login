...
# print(ControllerCadastro.cadastrar('Francisca', 'francisca@gmail.com', 'minhasenha' )) 
print(ControllerLogin.logi('francisca@gmail.com', 'minhasenha' ))
